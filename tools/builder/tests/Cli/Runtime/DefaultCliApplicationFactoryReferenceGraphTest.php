...
final class DefaultCliApplicationFactoryReferenceGraphTest extends TestCase
{
    public function testListCommandExposesReferenceGraphGenerator(): void
    {
        ...
        self::assertStringContainsString('  - reference.graph', $result->standardOutput);
    }
}
