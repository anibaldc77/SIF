...
final class DefaultCliApplicationFactoryRepositoryManifestTest extends TestCase
{
    public function testListCommandExposesRepositoryManifestGenerator(): void
    {
        ...
        self::assertStringContainsString('  - repository.manifest', $result->standardOutput);
    }
}
