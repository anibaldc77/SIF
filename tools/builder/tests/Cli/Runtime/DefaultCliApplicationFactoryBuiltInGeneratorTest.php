...
final class DefaultCliApplicationFactoryBuiltInGeneratorTest extends TestCase
{
    public function testListCommandExposesRepositoryIndexGenerator(): void
    {
        ...
        self::assertStringContainsString('repository.index', $result->standardOutput);
    }
}
