<?php
// source: phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar/conf/config.neon
// source: phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar/conf/config.level8.neon
// source: D:\SIF\phpstan.neon
// source: array
...
class Container_af94536004 extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.stubFilesExtension' => ['041' => true, '042' => true, '044' => true, '045' => true],
		'phpstan.diagnoseExtension' => ['088' => true],
		'phpstan.broker.allowedSubTypesClassReflectionExtension' => ['0110' => true],
		'phpstan.broker.propertiesClassReflectionExtension' => ['0111' => true, '0271' => true],
	...
	protected $wiring = [
		...
		'PHPStan\PhpDoc\StubFilesExtension' => [['041', '042', '044', '045']],
		...
		'PHPStan\Reflection\MethodsClassReflectionExtension' => [['093', '0103', '0105', '0107', '0109']],
		'PHPStan\Reflection\Annotations\AnnotationsMethodsClassReflectionExtension' => [['093']],
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [['094', '0104', '0106', '0107', '0111', '0271']],
		...
		'PHPStan\Type\DynamicStaticMethodReturnTypeExtension' => [['0212', '0215', '0217', '0229', '0336', '0342']],
		...
		'PHPStan\Collectors\Collector' => [['0436', '0437', '0439', '0440', '0442', '0443', '0445', '0467', '0468']],
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(80200, ['D:/SIF']);
	}
	...
	public function createService043(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			$this->getService('071'),
			[
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionAttribute.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionClass.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionClassConstant.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionFunctionAbstract.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionMethod.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionParameter.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\ReflectionProperty.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\iterable.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\ArrayObject.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\WeakReference.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\ext-ds.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\ImagickPixel.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\PDOStatement.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\date.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\ibm_db2.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\mysqli.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\zip.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\dom.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\spl.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\SplObjectStorage.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\Exception.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\arrayFunctions.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\core.stub',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\typeCheckingFunctions.stub',
			],
			['D:/SIF']
		);
	}
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_af94536004 $container)
			{
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'D:\SIF\var\phpstan/resultCache.php',
					...
					null,
					[
						'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionUnionType.php',
						'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionAttribute.php',
						'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\Attribute.php',
						'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\stubs\runtime\ReflectionIntersectionType.php',
					],
					[],
					[],
					$fileReplacements,
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('D:\SIF\var\phpstan/resultCache.php');
	}
	...
	public function createService066(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			['D:/SIF'],
			[
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\conf\parametersSchema.neon',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\conf\config.level8.neon',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\conf\config.level7.neon',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\conf\config.level6.neon',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\conf\config.level5.neon',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\conf\config.level4.neon',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\conf\config.level3.neon',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\conf\config.level2.neon',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\conf\config.level1.neon',
				'phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar\conf\config.level0.neon',
				'D:\SIF\phpstan.neon',
			],
			null,
			[
	...
	public function createService073(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'D:\SIF',
			'D:\SIF\var\phpstan',
			['phar://D:\SIF\vendor\phpstan\phpstan\phpstan.phar/conf/config.level8.neon', 'D:\SIF\phpstan.neon'],
			$this->getParameter('analysedPaths'),
			['D:/SIF'],
	...
	{
		return new PHPStan\File\FileHelper('D:\SIF');
	}


	public function createService082(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory($this->getService('083'), [], null);
	}
	...
	{
		return new PHPStan\Rules\Keywords\RequireFileExistsRule('D:\SIF');
	}
	...
	{
		return new PHPStan\Cache\FileCacheStorage('D:\SIF\var\phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_af94536004
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('D:\SIF');
	}
	...
	{
		return new PHPStan\File\SimpleRelativePathHelper('D:\SIF');
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludePaths' => null,
			'level' => 8,
			'paths' => ['D:\SIF\src\Foundation', 'D:\SIF\tests\Foundation'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'memoryLimitFile' => 'D:\SIF\var\phpstan/.memory_limit',
			'tempResultCachePath' => 'D:\SIF\var\phpstan/resultCaches',
			'resultCachePath' => 'D:\SIF\var\phpstan/resultCache.php',
			...
			'__validate' => true,
			'tmpDir' => 'D:\SIF\var\phpstan',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => 'D:\SIF\var\phpstan',
			'rootDir' => 'D:\SIF\vendor\phpstan\phpstan',
			'currentWorkingDirectory' => 'D:\SIF',
			...
			'composerAutoloaderProjectPaths' => ['D:/SIF'],
