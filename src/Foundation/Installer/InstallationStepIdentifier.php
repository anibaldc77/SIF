...
final readonly class InstallationStepIdentifier
{
    ...
    public function __construct(string $value)
    {
        ...
        if (
            ...
            throw new InvalidInstallationStepIdentifierException(
                sprintf('Invalid installation step identifier "%s".', $value),
            );
        }
