...
final readonly class RecoveryCodeChallengeResponseEndpoint
{
    ...
    public function handle(
        ...
        try {
            $payload = RecoveryCodeChallengeResponsePayload::fromJson(
        ...
        $result = $this->service->satisfyRecoveryCode($payload, $session, $now);
